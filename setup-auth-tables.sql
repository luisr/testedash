-- Adicionar colunas para autenticação na tabela users
ALTER TABLE users 
ADD COLUMN IF NOT EXISTS password_hash TEXT,
ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT TRUE;

-- Criar tabela de colaboradores do projeto
...
-- Inserir dados de teste para colaboradores
...
-- Adicionar senhas padrão para usuários existentes (apenas para desenvolvimento)
UPDATE users 
SET password_hash = '$2b$10$K7o8YZGNn2ZlgKzWVOxzfeJ4NuTNrWIYCMmLiKqXWYKJKJfNZUZqK' -- senha: "password123"
